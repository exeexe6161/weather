...
export const weatherLabels: Record<string, Record<Lang, string>> = {
  ...
  weather_haze:                 { de: "Dunst",                en: "Haze",                 tr: "Pus" },
  weather_dust_haze:            { de: "Staubiger Dunst",      en: "Dust haze",            tr: "Tozlu pus" },
  weather_blowing_dust:         { de: "Aufgewirbelter Staub", en: "Blowing dust",         tr: "Savrulan toz" },
  weather_dust_storm:           { de: "Staubsturm",           en: "Dust storm",           tr: "Toz fırtınası" },
  weather_sandstorm:            { de: "Sandsturm",            en: "Sandstorm",            tr: "Kum fırtınası" },
  weather_severe_sandstorm:     { de: "Starker Sandsturm",    en: "Severe sandstorm",     tr: "Şiddetli kum fırtınası" },
  weather_smoke:                { de: "Rauch",                en: "Smoke",                tr: "Duman" },
  weather_smoky_haze:           { de: "Rauchiger Dunst",      en: "Smoky haze",           tr: "Dumanlı pus" },
  weather_smog:                 { de: "Smog",                 en: "Smog",                 tr: "Hava kirliliği" },
  weather_severe_smog:          { de: "Starker Smog",         en: "Severe smog",          tr: "Yoğun hava kirliliği" },
  weather_saharan_dust:         { de: "Saharastaub",          en: "Saharan dust",         tr: "Sahra tozu" },
  weather_dust:                 { de: "Staub",                en: "Dust",                 tr: "Toz" },
