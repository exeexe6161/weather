...
export const uiLabels: Record<string, Record<Lang, string>> = {
  ...
  weatherDisclaimer: { de: "Alle Wetterdaten, Warnungen, Pollen und Luftqualitätswerte, Zeitangaben, Empfehlungen sowie gegebenenfalls Kalender und Feiertagsangaben dienen nur der allgemeinen Information. Sie können unvollständig, verzögert oder örtlich und zeitlich ungenau sein. Nicht als alleinige Grundlage für Gesundheit, persönliche Sicherheit, Reisen, Luftfahrt, Seefahrt, Verkehr oder Notfallplanung verwenden. Maßgeblich sind amtliche Dienste, Behörden und bei Gesundheitsfragen qualifiziertes Fachpersonal.", en: "All weather data, alerts, pollen and air quality values, times, recommendations and any calendar or holiday information are provided for general information only. They may be incomplete, delayed or inaccurate for a specific place or time. Do not use them as the sole basis for health, personal safety, travel, aviation, marine navigation, traffic or emergency planning. Consult official services and authorities, and qualified professionals for health matters.", tr: "Tüm hava durumu verileri, uyarılar, polen ve hava kalitesi değerleri, saat bilgileri, öneriler ile varsa takvim ve tatil bilgileri yalnızca genel bilgilendirme amaçlıdır. Eksik, gecikmiş veya belirli bir yer ya da zaman için hatalı olabilir. Sağlık, kişisel güvenlik, seyahat, havacılık, denizcilik, trafik veya acil durum planlamasında tek dayanak olarak kullanmayın. Resmi hizmetleri ve yetkili kurumları, sağlık konularında ise nitelikli uzmanları dikkate alın." },
