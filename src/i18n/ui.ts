...
export const uiLabels: Record<string, Record<Lang, string>> = {
  ...
  searchNoResults: { de: "Keine passenden Orte gefunden. Prüfe die Schreibweise.", en: "No matching places found. Check the spelling.", tr: "Eşleşen bir yer bulunamadı. Yazımı kontrol et." },
  ...
  searchTooShort:  { de: "Mindestens 3 Zeichen eingeben", en: "Enter at least 3 characters", tr: "En az 3 karakter gir" },
  ...
  searchError:     { de: "Suche derzeit nicht möglich. Versuche es erneut.", en: "Search is currently unavailable. Try again.", tr: "Arama şu anda kullanılamıyor. Tekrar dene." },
  geoBtn:          { de: "Mein Standort", en: "My location", tr: "Konumum" },
  geoHint:         { de: "Nur mit Zustimmung. Nicht dauerhaft gespeichert; an WeatherAPI übertragen.", en: "Only with consent. Not stored permanently; sent to WeatherAPI.", tr: "Yalnızca senin onayınla. Kalıcı olarak saklanmaz; WeatherAPI'ye iletilir." },
  ...
  favMoveUp:       { de: "{place} nach oben, Position {pos} von {total}", en: "Move {place} up, position {pos} of {total}", tr: "{place} yukarı taşı, {total} yerden {pos}. sırada" },
  favMoveDown:     { de: "{place} nach unten, Position {pos} von {total}", en: "Move {place} down, position {pos} of {total}", tr: "{place} aşağı taşı, {total} yerden {pos}. sırada" },
  favMovedAnnounce: { de: "{place} ist jetzt Position {pos} von {total}", en: "{place} is now position {pos} of {total}", tr: "{place} şimdi {total} yerden {pos}. sırada" },
  ...
  wind:            { de: "Wind", en: "Wind", tr: "Rüzgâr" },
  metric_rain_today: { de: "Regen heute", en: "Rain today", tr: "Bugünkü yağmur" },
  ...
  pollen_grass:    { de: "Gräser", en: "Grass", tr: "Çayır otu" },
  pollen_mugwort:  { de: "Beifuß", en: "Mugwort", tr: "Pelin otu" },
  pollen_hazel:    { de: "Hasel", en: "Hazel", tr: "Fındık ağacı" },
  pollen_oak:      { de: "Eiche", en: "Oak", tr: "Meşe" },
  pollen_ragweed:  { de: "Ambrosia", en: "Ragweed", tr: "Ambrosia" },
  ...
  aqi_calm:        { de: "Aktuell unauffällig", en: "Currently unremarkable", tr: "Şu anda dikkat çeken bir durum yok" },
  aqi_details_show: { de: "Details anzeigen", en: "Show details", tr: "Ayrıntıları göster" },
  aqi_details_hide: { de: "Details ausblenden", en: "Hide details", tr: "Ayrıntıları gizle" },
  ...
  aqi_hint_sensitive: { de: "Empfindliche Personen: längere Anstrengung im Freien etwas reduzieren", en: "Sensitive groups: ease up on longer outdoor exertion", tr: "Hassas kişiler: açık havada uzun süreli fiziksel aktiviteyi biraz azaltın" },
  aqi_hint_unhealthy: { de: "Längere Anstrengung im Freien reduzieren", en: "Reduce prolonged outdoor exertion", tr: "Açık havada uzun süreli fiziksel aktiviteyi azalt" },
  aqi_hint_severe:    { de: "Anstrengung im Freien möglichst meiden", en: "Avoid prolonged outdoor exertion", tr: "Açık havada uzun süreli fiziksel aktiviteden mümkünse kaçın" },
  ...
  alerts_title:    { de: "Wetterwarnungen", en: "Weather alerts", tr: "Hava durumu uyarıları" },
  ...
  alert_from:      { de: "Gültig ab {time}", en: "Valid from {time}", tr: "Geçerlilik başlangıcı: {time}" },
  alert_until:     { de: "Gültig bis {time}", en: "Valid until {time}", tr: "Geçerlilik bitişi: {time}" },
  ...
  alert_instruction: { de: "Hinweis der Warnstelle", en: "Official guidance", tr: "Resmi bilgilendirme" },
  alert_more_count: { de: "Weitere Warnungen vorhanden", en: "More alerts available", tr: "Başka uyarılar var" },
  alert_note:      { de: "Beachte zusätzlich die Hinweise amtlicher Stellen.", en: "Also follow guidance from official authorities.", tr: "Ayrıca resmi makamların uyarılarını dikkate al." },
  ...
  sum1_hot_dry:           { de: "Heiß und trocken, ans Trinken denken.", en: "Hot and dry, remember to drink.", tr: "Hava çok sıcak ve kuru, su içmeyi unutma." },
  ...
  sum_t_hot:       { de: "heiß", en: "hot", tr: "çok sıcak" },
  ...
  dress_until:     { de: "{stage} bis {time} Uhr, danach {next}", en: "{stage} until {time}:00, then {next}", tr: "{stage}, saat {time} sonrası {next}" },
  dress_add_rain:  { de: "Regenjacke oder Schirm", en: "Rain jacket or umbrella", tr: "Yağmurluk veya şemsiye" },
  rain_window:     { de: "Regen {prob} zwischen {from} und {to} Uhr", en: "Rain {prob} between {from}:00 and {to}:00", tr: "Saat {from} ile {to} arası yağmur olasılığı {prob}" },
  rain_none:       { de: "Kein Regen erwartet", en: "No rain expected", tr: "Yağmur beklenmiyor" },
  rain_none_more:  { de: "Kein Regen mehr erwartet", en: "No more rain expected", tr: "Bugün başka yağmur beklenmiyor" },
  ...
  hourHint:        { de: "Stunde antippen für Details.", en: "Tap an hour for details.", tr: "Ayrıntılar için bir saate dokun." },
  ...
  windDirection:   { de: "Windrichtung", en: "Wind direction", tr: "Rüzgâr yönü" },
  windGusts:       { de: "Böen", en: "Gusts", tr: "Rüzgâr hamleleri" },
  ...
  outlookLabel:    { de: "Ausblick", en: "Outlook", tr: "Sonraki günler" },
  day_wind_max:    { de: "Wind max", en: "Max wind", tr: "En yüksek rüzgâr" },
  ...
  noscriptText:    { de: "Diese App benötigt JavaScript. Bitte aktiviere JavaScript in deinem Browser.", en: "This app requires JavaScript. Please enable JavaScript in your browser.", tr: "Bu uygulama JavaScript gerektirir. Lütfen tarayıcında JavaScript'i etkinleştir." },
